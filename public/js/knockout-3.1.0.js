        ...
        (function (p) {
                            ...
                            function () {
                                ...
                                if (s || c || k !== n)
                                    s && a.ca.fa() && (r = a.a.lb(a.e.childNodes(b), !0)),
                                        k ? (s || a.e.U(b, a.a.lb(r)), a.gb(e ? e(l, g) : l, b)) : a.e.da(b),
                                        (n = k);
                            },
                            null,
                            { G: b }
            ...
            a.a = (function () {
                ...
                var e = { __proto__: [] } instanceof Array,
                    f = {},
                    h = {};
                f[K && /Firefox\/2/i.test(K.userAgent) ? 'KeyboardEvent' : 'UIEvents'] = [
                    'keyup',
                    'keydown',
                    'keypress',
                ];
                ...
                var g = { propertychange: !0 },
                    k =
                        ...
                        (function () {
                            for (
                                var a = 3, b = w.createElement('div'), c = b.getElementsByTagName('i');
                ...
                return {
                    ...
                    ha: function (b, c) {
                        ...
                        var d;
                        'input' === a.a.B(b) && b.type && 'click' == c.toLowerCase()
                    ...
                    Xa: function (b, c) {
                        ...
                        !e || 3 != e.nodeType || a.e.nextSibling(e)
                            ? a.e.U(b, [b.ownerDocument.createTextNode(d)])
                            : (e.data = d);
                        a.a.Vb(b);
                    },
                    Cb: function (a, b) {
                    ...
                    ob: function (b, c) {
                        for (
                            var d = a.a
                                    ...
                                    .concat(a.a.R(b.getElementsByTagName('textarea'))),
                                e =
                                    'string' == typeof c
                                        ? function (a) {
                                              return a.name === c;
                    ...
                    fc: function (b) {
                        return 'string' == typeof b && (b = a.a.ta(b))
                            ? C && C.parse
                                ? C.parse(b)
                    ...
                    gc: function (c, d, e) {
                        ...
                        if ('object' == typeof c && 'form' === a.a.B(c))
                            for (var h = c.action, f = k.length - 1; 0 <= f; f--)
                                for (var u = a.a.ob(c, k[f]), D = u.length - 1; 0 <= D; D--) g[u[D].name] = u[D].value;
                        d = a.a.c(d);
            ...
            (function () {
                a.a.Qa = function (b) {
                    ...
                    if (t)
                        ...
                        for (
                            'function' == typeof A.innerShiv ? c.appendChild(A.innerShiv(b)) : (c.innerHTML = b);
                            d[0]--;
                ...
                function b(c, e) {
                    if (c)
                        if (8 == c.nodeType) {
                            ...
                            for (var f = 0, h = c.childNodes, g = h.length; f < g; f++) b(h[f], e);
                }
                var c = {};
                return {
                    Na: function (a) {
            ...
            a.ub = function (b) {
                return ('function' == typeof b && b[E] === a.m) || ('function' == typeof b && b[E] === a.h && b.Yb)
                    ? !0
                    : !1;
            };
            a.b('observable', a.m);
                        ...
                        if (d && !f) {
                            ...
                            switch (c) {
                                ...
                                case 'splice':
                                    ...
                                    for (
                                        var m = 1 === q ? m : Math.min(c + (l[1] || 0), m),
                                            q = c + q - 2,
                                            s = Math.max(m, q),
                                            B = [],
                                            u = [],
                ...
                function h() {
                    if (!r && !q) {
                        ...
                        try {
                            ...
                            g.Ka(l, e) &&
                                (g.notifySubscribers(l, 'beforeChange'),
                                (l = e),
                    ...
                    if (l) {
                        ...
                        a.a.r(f, function (c) {
                            ...
                            try {
                                ...
                                throw (
                                    ((f.message =
                                        'Unable to process binding "' + g + ': ' + l[g] + '"\nMessage: ' + f.message),
                                    f)
                                );
                            }
                        });
                        ...
                        h = a.h(
                            function () {
                                var f = k ? b() : b,
                                    l = a.a.c(f);
                                c
                                    ? (c.D && c.D(), a.a.extend(g, c), h && (g.D = h))
                                    : ((g.$parents = []), (g.$root = l), (g.ko = a));
                                g.$rawData = f;
                                g.$data = l;
                                d && (g[d] = l);
                                e && e(g, c, l);
            ...
            a.d.attr = {
                update: function (b, c) {
                    ...
                    a.a.A(d, function (c, d) {
                        ...
                        8 >= a.a.oa && c in L
                            ? ((c = L[c]), h ? b.removeAttribute(c) : (b[c] = d))
                    ...
                    init: function (b, c, d) {
                        ...
                        function f() {
                            ...
                            if (!a.ca.pa() && (!k || g)) {
                                ...
                                l
                                    ? n !== f
                                        ? (g && (a.a.Y(h, f, !0), a.a.Y(h, n, !1)), (n = f))
                                        : a.a.Y(h, f, g)
                                    : a.g.va(h, d, 'checked', f, !0);
                            }
                        }
                        function h() {
                            var d = a.a.c(c());
            ...
            a.d.hasfocus = {
                ...
                update: function (b, c) {
                    ...
                    b.__ko_hasfocusUpdating ||
                        ...
                        (d ? b.focus() : b.blur(), a.k.t(a.a.ha, null, [b, d ? 'focusin' : 'focusout']));
                },
            };
            a.g.W.hasfocus = !0;
                ...
                update: function (b, c, d) {
                    ...
                    k &&
                        ...
                        d.has('optionsCaption') &&
                            ((k = a.a.c(d.get('optionsCaption'))), null !== k && k !== p && n.unshift(J)));
                    var m = !1;
                    ...
                    a.k.t(function () {
                        d.get('valueAllowUnset') && d.has('value')
                            ? a.i.X(b, a.a.c(d.get('value')), !0)
                            : (b.multiple
                                  ? r.length && e().length < r.length
                                  : r.length && 0 <= b.selectedIndex
                                  ? a.i.p(b.options[b.selectedIndex]) !== r[0]
                                  : r.length || 0 <= b.selectedIndex) && a.a.ha(b, 'change');
                    });
                    a.a.Tb(b);
                    ...
                    for (var k = a.g.aa, l = 0; l < b.length; l++) {
                        ...
                        if (k.hasOwnProperty(n)) {
                            ...
                            if ('function' === typeof r) {
                                ...
                                throw Error(
                                    "This template engine does not support the '" + n + "' binding within its templates"
                                );
                        }
                    }
                    d =
                        'ko.__tr_ambtns(function($context,$element){return(function(){return{ ' +
                        a.g.qa(b, { valueAccessors: !0 }) +
                        " } })()},'" +
                        d.toLowerCase() +
                        "')";
            ...
            (function () {
                ...
                a.d.template = {
                    init: function (b, c) {
                        ...
                        'string' == typeof d || d.name
                            ? a.e.da(b)
                            : ((d = a.e.childNodes(b)), (d = a.a.ec(d)), new a.n.Z(b).nodes(d));
                        return { controlsDescendantBindings: !0 };
                    },
                    update: function (b, c, d, e, f) {
                        var m = c(),
                        ...
                        'string' == typeof c
                            ...
                            : ((m = c.name),
                              ...
                              (q = a.a.c(c.data)));
                        'foreach' in c
                            ? (e = a.jc(m || b, (d && c.foreach) || [], c, b, f))
                            : d
                            ? ((f = 'data' in c ? f.createChildContext(q, c.as) : f), (e = a.Ta(m || b, f, c, b)))
                            : a.e.da(b);
                        f = e;
                ...
                a.g.aa.template = function (b) {
                    b = a.g.Ra(b);
                    return (1 == b.length && b[0].unknown) || a.g.bc(b, 'name')
                        ? null
                    ...
                    for (m = q; n || m; )
                        (q = l[n][m] - 1),
                            m && q === l[n][m - 1]
                                ...
                                : n && q === l[n - 1][m]
                                ? s.push((g[g.length] = { status: f, value: b[--n], index: n }))
                    ...
                    for (var z = [], m = [], v, x = 0, A, C; (A = q[x]); x++)
                        switch (((C = A.moved), A.status)) {
                            ...
                            case 'added':
                                C !== p
                                    ? k(x, C)
                                    : ((v = { ka: A.value, Ia: a.m(u++) }), s.push(v), y.push(v), n || (m[x] = v));
                        }
                    l(h.beforeMove, z);
            ...
            (function () {
                a.La = function () {
                    ...
                    0 < a &&
                        ...
                        (t.tmpl.tag.ko_with = { open: 'with($1) {', close: '} ' }));
                };
